...
if user_query is not None and user_query != "":
  ...
  with st.chat_message("AI"):
    start = timeCURRENT_DIR = os.path.dirname(os.path.abspath(__file__))                                                                                                    sys.path.append(os.path.dirname(CURRENT_DIR))                                                                                                                                                                                                                                                                                                                                                                                                                                       DATA_PATH = CURRENT_DIR + "/../data/main-data/synthetic-resumes.csv"                                                                                        FAISS_PATH = CURRENT_DIR + "/../vectorstore"                                                                                                                EMBEDDING_MODEL = "sentence-transformers/all-MiniLM-L6-v2".time()
